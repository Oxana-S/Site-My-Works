	...
	<div class="container">
		<div class="main__tarif" data-aos="fade-up">
			<div id="usual1" class="usual">
				<ul>
					<!-- Скрипт перехода по плавным ссылкам -->
					<li><a href="index.php" class="selected">Интернет</a></li>
					<!-- Подключение Скрипта перехода по ссылкам к якорю (yakor2) на страницу /index-internet-tv.php#yakor2-->
					<li><a onclick="javascript:addURL(this, '#yakor2');" href="index-internet-tv.php">Интернет + ТВ</a>
					</li>
				</ul>
				<div id="tab1">
			...
			<div class="main__steps_list">
				...
				<div class="main__steps_list-mobile">
					...
					<div class="main__steps_item-mobile" data-aos="fade-up">
						...
						<div class="steps_item-mobile-text">
							<h4>Выезд мастера</h4>
							<p>Специалист приедет в удобное для Вас время проведет интернет в день приема заявки.</p>
						</div>
					</div>
					<div class="main__steps_item-mobile" data-aos="fade-up">
		...
		<div class="main__advantages" data-aos="fade-up">
			<div class="owl-carousel owl-theme advantages-carousel">
				...
				<div class="advantages-carousel-item">
					...
					<p class="advantages-carousel-text">Регулярно запускаем акции для новых и постоянных клиентов. С
						нами выгодно!</p>
				</div>
				<div class="advantages-carousel-item">
					<div class="advantages-carousel-img">
