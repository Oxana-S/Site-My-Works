...
<div class="header__bottom">
    <div class="container">
        <div class="header__bottom_blocks">
            ...
            <div class="bottom_blocks-menu">
                <ul>
                    <li><img src="img/icon/wifi.png" alt="Иконка Вай Фай"> <a href="bussines.php"> Интернет</a></li>
    ...
    <main>
        ...
        <div class="main__request_back">
            ...
            <div class="container">
                <div class="main__request">
                    ...
                    <p class="animate__animated animate__bounceInLeft">Видеонаблюдение с установкой “под ключ” за 1 день
                    </p>
                    <div class="form__block" data-form-title="Будь в курсе 24/7">
                        <form class="request__form animate__animated animate__bounceInUp">
                            ...
                            <label class="name input__group input__group--short">
                                <input class="main__form_phone" required="" name="phone" type="tel"
                                    placeholder="Телефон">
                            </label>
                            <button type="button"
                                class="button button--large button--shadow request__form_button">Оставить
                                заявку</button>
                        </form>
                    </div>
                </div>
            ...
            <duv class="inside-tarif">
                <div class="inside-tarif-item" data-aos="zoom-in-down">
                    ...
                    <ul>
                        ...
                        <li>Время хранения: 7 дней</li>
                        <li>7 дней дополнительного хранения 250 руб/месяц</li>
                ...
                <div class="inside-tarif-item" data-aos="zoom-in-down">
                    ...
                    <ul>
                        ...
                        <li>Время хранения: 7 дней</li>
                        <li>250 руб/месяц за каждую камеру</li>
                        <li>7 дней дополнительного хранения 250 руб/мес за каждую камеру</li>
                        <li>Стоимость камеры и подключение “ под ключ” от 6 999 руб/месяц</li>
                        <!-- <li>Установка в день обращения</li> -->
                    </ul>
                    <div class="inside-tarif-price">
                        <p>500/700<br><span>₽/месяц</span></p>
                        <a onclick="openModal('.callback-modal-42')">Подключить</a>
                    </div>
                </div>
            </duv>
        </div>
        <!--Возможности видео-наблюдения-->
        ...
        <!--Стоимость камеры и подключение “ под ключ”-->
        <div class="main__title" data-aos="fade-up">
            <h3>
            ...
            <div class="container">
                <ul class="camera-list">
                    ...
                    <li><span>+</span>Оставьте заявку и получите специальные условия на подключение wi-fi
                        интернета,<br /> цифрового телевидения и облачного видеонаблюдения.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="main__form_back" data-aos="fade-up">
            ...
            <div class="container" data-aos="fade-up">
                <div class="main__form_title">
                    Оставьте заявку и получите до 50 000 рублей на продвижение вашего бизнеса в интернете, а также 10
                    дней на все услуги в подарок. Наш менеджер перезвонит Вам и подберет наиболее выгодный тариф
                </div>
        ...
        <div class="container" data-aos="fade-up">
            <div class="main__services">
                ...
                <p>Сеть кабельного телевидения от группы компаний «Мир Антенн» на 100% использует современные
                    оптоволоконные технологии. Специалисты предприятия ежегодно повышают свою квалификацию. Мы
                    гарантируем качество наших услуг.</p>
